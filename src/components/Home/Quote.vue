...
<section class="bg-white text-vegan-black body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <p class="leading-relaxed text-lg"> All the arguments to prove man's superiority cannot shatter this hard fact: in suffering the animals are our equals.</p>
      <span class="inline-block h-1 w-10 rounded bg-yellow-400 mt-8 mb-6"></span>
      <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">PETER SINGER</h2>
      <p class="text-gray-500">ETHICS PHILOSOPHER</p>
    </div>
  </div>
</section>
</template>
